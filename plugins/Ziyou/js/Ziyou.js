(function () {
    ...
    var Demo = {
        ...
        addTargetEntity: function (data) {
            ...
            //对象名称
            var name = "Target";
            //自定义id(不能包含特殊字符："_"，会影响自定义坐标系下轨道的显示)
            var id = "satellite/" + name;
            ...
            //  已存在对象，则仅更新位置、姿态
                ...
                var entityTp = Cesium.CzmlDataSource.processEntityPacket(data);
                entity.position = entityTp.position;
                //entity.orientation = entityTp.orientation;
            }
