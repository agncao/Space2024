 ...
 * @LastEditTime: 2022-11-17 15:13:06
...
class Debris {
    ...
    start(callback) {
        var that = this
        // 获取2个异步结果
        // /plugins/Debris/js/satcat.tet
        let urltext = null
        // urltext = "/plugins/Debris/js/satcat.txt";
        urltext = "http://astrox.cn:8765/satcat";

        // http://astrox.cn:8765/satcat
        let urljson = null
        // urljson = "/plugins/Debris/js/ssc.json";
        urljson = "http://astrox.cn:8765/ssc";
